                ...
                <div className="col-4">
                    ...
                    <form onSubmit={handleSubmit(simpan)} >
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" name="kategori" placeholder="kategori" {...register("kategori", {required:true})} 
                            />
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" name="keterangan" placeholder="keterangan" {...register("keterangan")} />
                        </div>

                        <div className="mb-3">
                            <input type="submit" className="btn btn-primary" name="kategori" />
                        </div>
                    </form>
